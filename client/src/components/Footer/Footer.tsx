...
export const Footer: React.FC = () => {
  const [links, setLinks] = useState<{id: number, title: string,url: string, external: boolean}[]>([
    ...
    {id: 3, title: "Contract", url:"https://testnet.bscscan.com/address/0x3fd0e2d4174e33ecf9b617f31238de46ad6737ac#readContract", external: true},
  ])
  return (
    <Styled.FooterMain>
      <Styled.FooterTitle>Artform</Styled.FooterTitle>
      <Styled.FooterNav>
        {
