...
contract NFTArt is ERC721Enumerable, Ownable{
    ...
    address constant public WITHDRAW_ADDRESS = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    ...
    // добавить админа, меняется владельцем
   ...
   /*///////////////////////////////////////////////////////////////
    ...
    function buyToken(uint256 _tokenID) external payable ifTockenExist(_tokenID) {
        ...
        // проверить логику при сценарии самостоятельной продажи при _lotStates[_tokenID] = 3
        
        payable(_previousOwner).transfer(getTokenPrice(_tokenID));  // проверить что забирает средства с сендера
